...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int SILVER_COIN = 11;
		...
		public static final int SILVER_COIN_VALUE = 50;
		...
		public static final int COIN_WIDTH = (int) (Game.SCALE * POTION_WIDTH_DEFAULT);
		public static final int COIN_HEIGHT = (int) (Game.SCALE * POTION_HEIGHT_DEFAULT);
	...
	public static class UI {
		...
		public static class ModeButtons {
			public static final int MODE_B_WIDTH_DEFAULT = 140;
			public static final int MODE_B_HEIGHT_DEFAULT = 56;
			public static final int MODE_B_WIDTH = (int) (MODE_B_WIDTH_DEFAULT * Game.SCALE);
			public static final int MODE_B_HEIGHT = (int) (MODE_B_HEIGHT_DEFAULT * Game.SCALE);
		}
