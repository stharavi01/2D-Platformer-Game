...
public class Player extends Entity {
	...
	private int tempValue,finalScore;
	...
	public int changeScore(int silverCoinValue) {
		// TODO Auto-generated method stub
		scoreValue += silverCoinValue;
		return scoreValue;
	}
	...
	private void loadAnimations() {
		...
		for (int j = 0; j < animations.length; j++)
			for (int i = 0; i < animations[j].length; i++)
				animations[j][i] = img.getSubimage(i * 64, j * 32, 64, 32);
