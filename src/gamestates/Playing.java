...
public class Playing extends State implements Statemethods {
	...
	//for score
	public int scoreValue = 0 ,tempValue,values;
  ...
  public int getScoreValue(){
	  tempValue = scoreValue;
	  return player.changeScore(scoreValue);
  }
	...
	private void initClasses() {
		...
		player = new Player(200, 200, (int) (64 * Game.SCALE), (int) (32 * Game.SCALE), this);
	...
	private void drawScore(Graphics g)
	{
		...
		g.drawString("Score: "+getScoreValue(), 540,50 );
